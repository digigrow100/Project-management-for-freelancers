...
export function DomainExpiryTicker({ items }: { items: DomainExpiryTickerItem[] }) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(4rem+env(safe-area-inset-bottom))] z-30 border-t border-amber-500/30 bg-base-900/95 backdrop-blur-sm md:bottom-[env(safe-area-inset-bottom)]">
      <Link
        href="/domains"
